...
conn.execute('''CREATE TABLE EMPLOYEE4
...
conn.execute("INSERT INTO EMPLOYEE4 (ID,NAME,AGE,ADDRESS,SALARY)\
...
resultset=conn.execute("SELECT id,name,age,address,salary from EMPLOYEE4")
